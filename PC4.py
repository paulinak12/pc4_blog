...
if pagina_seleccionada == 'Inicio':
    ...
    texto = """
    Hola, soy Paulina Kosaka, tengo 21 años y estudio la carrera de Publicidad. Desde que empecé a estudiar esta carrera, descubrí lo mucho que me apasiona la creatividad, las ideas que conectan con las personas y el poder que tiene un buen mensaje cuando está bien pensado.
    Soy una persona súper activa y curiosa. Toda mi vida he estado vinculada al deporte: jugué vóley durante muchos años y, hasta ahora, practico lanzamiento de jabalina como hobby. Es algo que me encanta porque me ayuda a mantenerme enfocada, liberar energía y sentirme bien conmigo misma.
    En mi tiempo libre me gusta estar rodeada de lo que me inspira: la música, que es mi compañera de todos los días; ver películas o series, especialmente si tienen tramas de suspenso o giros inesperados, leer libros de misterio, jugar videojuegos para despejarme un rato y salir con mis amigas para desconectarme un poco del ritmo diario.
    ...
    texto_2 = """
    Aprender a programar fue como meterme a una dimensión nueva. Al principio todo parecía hecho en otro idioma, pero poco a poco empecé a entender cómo funciona la lógica detrás de las cosas que usamos todos los días. Es como construir con bloques invisibles que hacen que una web, una app o incluso un videojuego cobre vida.
    No voy a mentir, a veces puede ser confuso, especialmente si nunca antes te has metido en este mundo, pero también es súper interesante darte cuenta de que con unas líneas de código puedes crear algo tuyo. A mí me ha ayudado a tener otra forma de pensar, a estructurar mejor mis ideas... y hasta a tener más paciencia.
    """
    ...
    if grafico_seleccionado == 'Distribución de tipos de contenido en Netflix':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>Este gráfico circular muestra que la mayoría del contenido en Netflix corresponde a películas (69.6%), mientras que las series o TV Shows representan solo el 30.4%. Esto sugiere que, aunque Netflix ha apostado fuertemente por sus series originales, su catálogo sigue siendo dominado por películas.</div>", unsafe_allow_html=True)
        st.image("grafico_pie.png", caption='Distribución de tipos de contenido en Netflix', width=500)
        pass
    elif grafico_seleccionado == 'Producciones estrenadas en Netflix por año':
